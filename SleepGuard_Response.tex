...
Specifically, we have made the following changes to the revised paper:

\begin{itemize}

\item We have acknowledged the limitations of our evaluation and analysis according to the feedback given by Reviewer 1 in
    Section 4.2.3. We also provided a discussion with respect to ``Sleep As Android" and ``Sleep Hunter" in Section 4.2.3;

\item In Section 4.1.3, we provide the percentages of the three hand positions, Abdomen, Chest, Head, during sleep in our pilot dataset;

\item In Section 4.1.4, we give the number of micro body movements for each of our test participants;

\item The data in Table 9 is the average of the sleep quality scores, and we now add standard deviation measurements and additional indicators in Table 9.
