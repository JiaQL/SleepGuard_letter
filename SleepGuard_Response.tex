...
\item We have acknowledged the limitations of our evaluation and analysis according to the feedback given by Reviewer 1. We also provided a discussion with respect to ``Sleep As Android" and ``Sleep Hunter" in Section 4.2.3;
